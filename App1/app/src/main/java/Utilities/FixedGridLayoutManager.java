...
public class FixedGridLayoutManager extends RecyclerView.LayoutManager {
    ...
    private int maxScrollSpeed = 100000000;
    private int minScrollSpeed = -100000000;
    ...
    public int getMinScrollSpeed() {
        return minScrollSpeed;
    }

    public void setMinScrollSpeed(int minScrollSpeed) {
        this.minScrollSpeed = minScrollSpeed;
    }
...
//We do allow scrolling
    ...
    */
    ...
    public int scrollHorizontallyBy(int dx, RecyclerView.Recycler recycler, RecyclerView.State state) {
        dx =  Math.min(dx, maxScrollSpeed);
        dx =  Math.max(dx, minScrollSpeed);
...
//We do allow scrolling
    ...
    */
    ...
    public int scrollVerticallyBy(int dy, RecyclerView.Recycler recycler, RecyclerView.State state) {
        dy =  Math.min(dy, maxScrollSpeed);
        dy =  Math.max(dy, minScrollSpeed);
